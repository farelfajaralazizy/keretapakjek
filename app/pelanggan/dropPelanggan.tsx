...
const DropPelanggan = (myProp: props) => {
        ...
        try {
            ...
            if(response.data.success === true) {
                toast(message, {
                    ...
                    containerId: `toastDrop-${myProp.pelanggan.id}`, 
                    type: `success`
                })
                setShow(false)
                // reload page
            ...
            console.log(error)
            toast(`Something went wrong`, {containerId: `toastDrop-${myProp.pelanggan.id}`, type: `success`})
        }
    }
    return (
        <div className="">
            <ToastContainer containerId={`toastDrop-${myProp.pelanggan.id}`} />
