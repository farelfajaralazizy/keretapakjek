...
const History = (props: Props) => {
  return (
    <div className='bg-yellow-300 rounded-lg shadow-lg border border-gray-200 p-6 w-full transition-all hover:shadow-xl'>
      ...
      <div className="space-y-4">
        <h1 className="text-xl font-bold text-green-600 mb-4">List Penumpang</h1>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-sky-50">
              <tr>
                <th className="text-orange-600 text-sm font-bold py-3 px-4 text-left">Nama</th>
                <th className="text-pink-600 text-sm font-bold py-3 px-4 text-left">NIK</th>
...
const InfoSection = ({ title, content, subContent }: { 
  ...
  <div className='space-y-2'>
    <div className='font-bold text-purple-700 text-lg'>{title}</div>
